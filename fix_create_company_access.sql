-- Script para corrigir a função create_company_access
-- Execute este script diretamente no SQL Editor do Supabase para aplicar a correção imediatamente
...
BEGIN
  ...
  IF p_password IS NULL OR p_password = '' THEN
    RAISE EXCEPTION 'password cannot be null or empty. Received: %', p_password;
  END IF;
