...
export const BackgroundManager = () => {
  ...
  return <div className="space-y-6">
      <div>
        <h3 className="mb-2 px-0 py-[10px] font-bold text-xl">Interface de Login</h3>
        ...
        <CardContent className="p-6 px-[40px] py-[40px] rounded-sm">
          <form onSubmit={handleSubmit} className="space-y-4 py-0">
            ...
            <div className="flex justify-end">
              <Button type="submit" disabled={isSaving || isUploading} className="bg-merinno-dark hover:bg-black text-white">
