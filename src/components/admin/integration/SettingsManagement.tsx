...
import { Loader2, Building, Video, FileText, Users, Key, Book } from "lucide-react";
      ...
      {selectedCompany ? (
              ...
              <div className="border-b">
                <TabsList className="bg-gray-50 dark:bg-gray-900 w-full justify-start rounded-none p-0 h-auto">
                  ...
                  <TabsTrigger 
                    ...
                    className="flex items-center py-3 px-6 data-[state=active]:bg-white dark:data-[state=active]:bg-gray-800 rounded-none border-b-2 border-transparent data-[state=active]:border-blue-500"
                    style={{
                      borderColor: activeTab === "collaborators" ? selectedCompany?.cor_principal || "#1EAEDB" : "transparent"
                    }}
                  >
                  ...
                  <TabsTrigger 
                    ...
                    className="flex items-center py-3 px-6 data-[state=active]:bg-white dark:data-[state=active]:bg-gray-800 rounded-none border-b-2 border-transparent data-[state=active]:border-blue-500"
                    style={{
                      borderColor: activeTab === "courses" ? selectedCompany?.cor_principal || "#1EAEDB" : "transparent"
                    }}
                  >
        ...
        <Card>
          <CardContent className="p-6 text-center">
            ...
            <p className="text-gray-500 dark:text-gray-400">
              Selecione uma empresa para gerenciar suas configurações.
            </p>
          </CardContent>
        </Card>
      )}
