  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
        <div>
          <h3 className="text-base font-semibold text-foreground mb-1">Identidade visual</h3>
          <p className="text-sm text-muted-foreground">Logo e cores que representam sua empresa</p>
        </div>
