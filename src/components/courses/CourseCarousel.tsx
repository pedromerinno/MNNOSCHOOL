...
export const CourseCarousel: React.FC<CourseCarouselProps> = ({
  ...
  if (hasSingleCourse) {
    ...
    return (
      <div className="w-full relative overflow-hidden py-0 flex justify-center relative z-10 mt-20 lg:mt-0">
  ...
  return (
    <div className="w-full relative overflow-hidden py-0 relative z-10 mt-20 lg:mt-0">
      <Carousel 
        opts={{
          align: "center",
          loop: true
