...
import { Heart, ChevronRight, Users, UserRound } from 'lucide-react';
...
export const CourseCard: React.FC<CourseCardProps> = ({ course }) => {
  ...
  return (
    <Link to={`/courses/${id}`} className="block">
      <Card className={cn(
        "overflow-hidden border border-gray-100 dark:border-gray-800 hover:shadow-md transition-all cursor-pointer",
        "w-[380px] max-w-[400px]"
      )}>
        {/* Hero Image */}
