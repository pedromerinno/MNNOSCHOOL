...
const PLACEHOLDERS = [
  ...
  "Como posso criar um novo curso?",

  "Explique sobre integração de sistemas",

  "Quais são os recursos disponíveis?",

  "Como funciona o dashboard?",

  "Preciso de ajuda com configurações",

  "Mostre cursos sugeridos",
  ...
  return (
    ...
    <div className="w-full flex justify-center items-center">
      ...
      <motion.div
        ...
        className="w-full max-w-3xl bg-white dark:bg-[#1a1a1a]"
      ...
      >
        ...
        <div className="flex flex-col items-stretch w-full h-full">
          ...
          <div className="flex items-center gap-2 p-3 rounded-full bg-white dark:bg-[#1a1a1a] max-w-3xl w-full">
            ...
            <button
              ...
              className="flex items-center gap-1 bg-black dark:bg-white hover:bg-zinc-700 dark:hover:bg-gray-200 text-white dark:text-black p-3 rounded-full font-medium justify-center transition"
              ...
              <button
                ...
                className={`flex items-center gap-1 px-4 py-2 rounded-full transition-all font-medium group ${
                  ...
                  thinkActive
                    ...
                    ? "bg-blue-600/10 dark:bg-blue-400/10 outline outline-blue-600/60 dark:outline-blue-400/60 text-blue-950 dark:text-blue-300"
