...
import { DiscussionLoadingSkeletons, DiscussionLoadingIndicator } from "@/components/community/DiscussionLoadingIndicator";
  ...
  return (
    <CommunityLayout>
      <div className="">
        <div className="flex flex-col gap-4 mb-6">
          <div className="flex items-center justify-between gap-4 flex-wrap md:flex-nowrap">
            <div className="flex gap-2 p-1.5 rounded-2xl order-2 md:order-1 w-full md:w-auto" style={{
              ...
              <Button 
                ...
                className={cn("rounded-xl py-4 px-6 transition-colors", statusFilter === 'all' ? `bg-background` : '')} 
                style={{
              ...
              <Button 
                ...
                className={cn("rounded-xl py-4 px-6 transition-colors", statusFilter === 'open' ? `bg-background` : '')} 
                style={{
              ...
              <Button 
                ...
                className={cn("rounded-xl py-4 px-6 transition-colors", statusFilter === 'closed' ? `bg-background` : '')} 
                style={{
          ...
          {totalCount > 0 && (
            <div className="text-sm text-gray-500">
              {filteredDiscussions.length === totalCount 
                ? `${totalCount} discussões encontradas`
                : `${filteredDiscussions.length} de ${totalCount} discussões`
              }
            </div>
          )}
        </div>
        ...
        {isLoading ? (
          <DiscussionLoadingSkeletons count={3} />
          ...
          <>
            ...
            <DiscussionLoadingIndicator
              hasMore={hasMore}
              onLoadMore={loadMoreDiscussions}
              totalCount={totalCount}
              currentCount={discussions.length}
            />
          </>
        )}
      </div>
